    ...
    <>
      ...
      <main className='bg-gray-200'>
        ...
        <div className='flex flex-row object-center items-center justify-center gap-8 p-10'>
            <div className='align-middle'><button type='button' onClick={() => router.push('/Contact')} className='text-black bg-gray-500 p-2 font-bold text-md rounded-md flex align-middle'><MdOutlineRequestQuote className='text-3xl align-middle mr-2'/>Get Quotes</button></div>
